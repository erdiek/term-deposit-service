...
│   ├── model.joblib    # Model will be saved here (generated by training)
│   └── metrics.json    # Local experiment tracking logs will be saved here (generated by training)
├── .gitignore          # data and model is hidden
